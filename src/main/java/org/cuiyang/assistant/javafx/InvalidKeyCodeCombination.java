package org.cuiyang.assistant.javafx;
/*
 ...
 * @since JavaFX 2.0
 */
public final class InvalidKeyCodeCombination extends KeyCombination {
     ...
     */
    public InvalidKeyCodeCombination(final @NamedArg("code") KeyCode code,
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof javafx.scene.input.KeyCodeCombination)) {
            return false;
        }

        return (this.getCode() == ((javafx.scene.input.KeyCodeCombination) obj).getCode())
                && super.equals(obj);
    }
